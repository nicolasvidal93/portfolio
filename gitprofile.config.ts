...
const CONFIG = {
      ...
      projects: [
        {
          ...
          imageUrl:'https://github.com/nicolasvidal93/portfolio/blob/main/portal_no2.PNG',
        ...
        },
        {
          ...
          imageUrl:
            'https://raw.githubusercontent.com/nicolasvidal93/portfolio/main/portal_IDESoB.PNG',
  ...
  resume: {
    fileUrl:
      'https://github.com/nicolasvidal93/README/blob/main/CV_Nicolas_E_Vidal_Quini.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
   'Google Earth Engine',
    'Phyton basic',
